...
import com.javabase.demo.constant.Constant;
import com.javabase.demo.constant.ResultConstant;
import com.javabase.demo.utils.LoginSessionUtils;
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (doFilter) {
			...
			if (StringUtils.isEmpty(sessionId) && StringUtils.isEmpty(sessionId)) {
				...
				out.print(JSONUtils.toJson(Constant.SESSION_TIMEOUT));
				return;
			}
