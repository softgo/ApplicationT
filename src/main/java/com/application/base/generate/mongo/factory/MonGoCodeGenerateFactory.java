package com.application.base.generate.mongo.factory;
...
import com.application.base.generate.mongo.bean.CommonPageParser;
import com.application.base.generate.mongo.bean.CreateBean;
import com.application.base.generate.mongo.def.CodeResourceUtil;
...
public class MonGoCodeGenerateFactory {
	...
	public static void initMySql(){
		try {
			 Properties props = PropertiesGetUtils.getProperties("/config/java_generate.properties");
	...
	public static void codeGenerate(String tableName, String codeName,
		...
		String basicPackage = (buss_package+"/"+entityPackage).replaceAll("/", ".");
