...
public class CommonBeanUtils {
	...
	public static <T extends BaseBean> T transMap2BasePO(Map<String, Object> map, Class<? extends BaseBean> clazz) {
	...
	public static <T extends BaseBean> T transMap2BasePO(Map<String, Object> map, T po) {
		if (map == null || po == null) {
			logger.warn("map is null. trans failure");
			return null;
		}
