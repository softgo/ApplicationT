...
public interface StrutsBaseDao<T> {
	 ...
	 * @return
	 */
	int updateObjectByID(Map<String, Object> param, Object objId,String factoryTag) throws BusinessException;
	 ...
	 * @return
	 */
	int updateObjectByUUID(Map<String, Object> param, String uuid,String factoryTag) throws BusinessException;
