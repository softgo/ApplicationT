package ${baseFilePackage}.dao.impl;
...
import ${baseFilePackage}.dao.MongoDao;
import ${baseFilePackage}.entity.Mongo;
...
public class ${className}DaoImpl extends BaseQueryService<${className}> implements ${className}Dao{
	...
	public PageView findObjsByPage(PageView pageView, Mongo t) {
		try {
			...
			List<${className}> list = this.mongoTemplate.find(query, getClassName());
